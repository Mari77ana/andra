function formFunktion() {
  ...
  if (forNamn !== "" && efterNamn !== "" && mailAdress !== "") {  // Användaren får inte lämna tomma fält
    for (var i = 0; i < inputs.length; i++) {                     //loopen lopar igenom värden det användaren skrev in och
